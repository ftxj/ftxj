...
for epoch in range(1, warm_up_epoch + perf_epoch):    
    ...
    print(f'Epoch: {epoch:03d}, Train Loss: {train_loss:.3f}, Train Acc: {train_acc:.3f}, Val Loss: {val_loss:.3f}, Val Acc: {val_acc:.3f}, Test Loss: {test_loss:.3f}, Test Acc: {test_acc:.3f}')
