...
img="gitlab-master.nvidia.com/wkong/open-catalyst:21.10-py3-devel-oc20"
...
if [ "$cluster" == "computelab" ];then
  ...
  cmd=$binary' -i -q chip='$chip' -t '$timeout' -img '$img' -a=" --ipc=host -p 8888:8888 --privileged -v /home/scratch.jxin_gpu/:/workspace2 --shm-size 300G "'
